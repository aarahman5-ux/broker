  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        width: '120%',
        height: '100%',
        background: 'radial-gradient(ellipse at center, rgba(184, 157, 124, 0.15) 0%, transparent 65%)',
        top: '-20%',
        left: '-10%',
        pointerEvents: 'none'
      }} />
        ...
        <svg width="100%" height="100%" viewBox="0 0 400 200" fill="none" xmlns="http://www.w3.org/2000/svg">
          <defs>
            ...
            <linearGradient id="glowGrad" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="#b89d7c" stopOpacity="0.4" />
              <stop offset="100%" stopColor="#b89d7c" stopOpacity="0" />
            </linearGradient>
          </defs>
        ...
        <svg width="100%" height="100%" viewBox="0 0 400 200" fill="none" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient id="sunsetGrad" x1="0" y1="0" x2="0" y2="1">
              ...
              <stop offset="100%" stopColor="#b89d7c" />
            </linearGradient>
          ...
          <g transform="translate(45, 85)">
            ...
            <rect x="8" y="40" width="98" height="8" fill="#b89d7c" />
        ...
        <svg width="100%" height="100%" viewBox="0 0 400 200" fill="none" xmlns="http://www.w3.org/2000/svg">
          <defs>
            ...
            <linearGradient id="goldBar" x1="0" y1="0" x2="1" y2="0">
              <stop offset="0%" stopColor="#b89d7c" />
              <stop offset="100%" stopColor="#9c8362" />
            </linearGradient>
          </defs>
          ...
          <g transform="translate(60, 50)">
            ...
            <circle cx="70" cy="92" r="20" fill="#4a5c68" stroke="#b89d7c" strokeWidth="2" />
            <circle cx="70" cy="92" r="8" fill="#1b2329" />
            <circle cx="220" cy="92" r="20" fill="#4a5c68" stroke="#b89d7c" strokeWidth="2" />
      ...
      {isFerrari && (
        <svg width="100%" height="100%" viewBox="0 0 400 200" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <g transform="translate(50, 60)">
            ...
            {/* Wheels */}
            <circle cx="75" cy="80" r="22" fill="#1b2329" stroke="#b89d7c" strokeWidth="1.5" />
            <circle cx="235" cy="80" r="22" fill="#1b2329" stroke="#b89d7c" strokeWidth="1.5" />
            <circle cx="75" cy="80" r="6" fill="#fef08a" />
            <circle cx="235" cy="80" r="6" fill="#fef08a" />
          </g>
          {/* Line highlight */}
          <path d="M0 140 L400 140" stroke="rgba(184, 157, 124, 0.2)" strokeWidth="1" />
        </svg>
      )}
      ...
      {isYacht && (
        <svg width="100%" height="100%" viewBox="0 0 400 200" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <g transform="translate(60, 80)">
            ...
            {/* Gold stripe */}
            <path d="M22 67 L265 67" stroke="#b89d7c" strokeWidth="2" />
          </g>
          {/* Waves */}
      ...
      {isWatch && (
        <svg width="100%" height="100%" viewBox="0 0 400 200" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Watch case */}
          <circle cx="200" cy="100" r="65" fill="url(#watchDial)" stroke="#b89d7c" strokeWidth="3" />
          {/* Notches */}
          {[0, 30, 60, 90, 120, 150, 180, 210, 240, 270, 300, 330].map((deg) => (
            <g key={deg} transform={`rotate(${deg} 200 100)`}>
              <line x1="200" y1="40" x2="200" y2="48" stroke="#b89d7c" strokeWidth="2" />
            </g>
          ))}
          {/* Gears */}
          <circle cx="185" cy="110" r="18" fill="none" stroke="#b89d7c" strokeWidth="1.5" strokeDasharray="3 2" opacity="0.6" />
          ...
          <line x1="200" y1="100" x2="180" y2="120" stroke="#b89d7c" strokeWidth="1.5" strokeLinecap="round" />
          {/* Pin */}
          <circle cx="200" cy="100" r="4" fill="#b89d7c" />
        </svg>
      )}
      ...
      {!isPorsche && !isFerrari && !isPenthouse && !isVilla && !isYacht && !isWatch && (
        <svg width="100%" height="100%" viewBox="0 0 400 200" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <rect x="120" y="60" width="160" height="80" rx="4" fill="#ffffff" stroke="#b89d7c" strokeWidth="2" />
